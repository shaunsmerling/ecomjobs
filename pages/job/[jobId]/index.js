  ...
  return (
    ...
    /> */}
      ...
      <Head>
        ...
        <meta
          property="og:title"
          content={`${jobs.job_position} | ${jobs.company_name}`}
          key="maintitle"
        />
        <meta
          property="og:description"
          content={`${jobs.job_description}`}
          key="description"
        />
        <meta
          property="og:image"
          content={`https://ecomportal.co/images/${jobs.logo}`}
          key="mainimage"
        />
        <meta
          name="twitter:card"
        ...
        <meta
          ...
          key="twtitle"
          content={`${jobs.company_name} is hiring for a ${jobs.job_position}!`}
        />
        <meta
          name="twitter:text:description"
          vmid="twitter:text:description"
          key="twdesc"
          content={`${jobs.job_description}`}
        />
        <meta
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-96">
              <div>
                <div class="mt-4 ml-6">
                  ...
                  <a href={`/company/${jobs.company_id}`}>
                  ...
                  <div class=" text-blueGray-600 my-2">
                    ...
                    <a href={jobs.company_url} className="text-sky-400">
                      {jobs.company_url}
                    </a>
                  </div>
           ...
           */}
              ...
              <div className="text-center">
                ...
                <h3 className="my-1 text-md lg:text-xl text-[#6879a5]">
                  {" "}
                  {jobs.job_category} • {jobs.job_type} • {getDate()}
                </h3>
              </div>
