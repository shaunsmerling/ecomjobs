  ...
  <section class="relative">
    <div class="container mx-auto  px-4">
      <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-96">
       ...
       <p className="text-xl lg:px-10 mx-auto mt-10 mb-8 ">      {companyData.mission ? companyData.mission : companyData.company_description }</p>
            <div class="mb-2 text-blueGray-600 mt-10">
              <i class="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i><a href={companyData.company_url} className="text-sky-400">{companyData.company_url}</a>
            </div>
...
<p  className="hidden lg:block text-center text-3xl  ">Available Jobs</p>
      ...
      <div className={`flex flex-col my-10 lg:mx-20 pb-2 `}>
        ...
        <img className="z-1 mt-4 ml-4 w-14 h-14 rounded-full border border-[#17614A] border-2 "   ></img>
          <li className="w-full ml-2 mt-2 mb-4 box-border ">
            ...
            <p className=" ml-2 -mb-2 z-1 text-xl text-[#17614A] z-0 font-bold pb-2 pr-20"></p>
