...
<div class=" my-8 mb-20 mx-auto text-center">
      ...
      <form onSubmit={handleSubmit} className=" ">
        <div className="mx-6 my-10 flex flex-col ">
          ...
          <button
            href="#"
            type="submit"
            class="flex relative items-center justify-center  sm:w-auto lg:mx-auto lg:px-60 py-3 sm:text-sm text-base sm:py-3.5 font-semibold text-white transition-all duration-200 bg-[#17614A] border border-transparent rounded-lg  hover:bg-[#114031] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
          >
           Save
          </button>
        </div>
