...
function SignIn()  {
    ...
    <div className="px-4 mx-auto max-w-7xl sm:-pb-10 ">
        <div className="relative max-w-md mx-auto lg:max-w-lg">
            <div className="absolute -inset-2">
                <div className="w-full h-full mx-auto rounded-3xl opacity-30 blur-lg filter bg-gradient-to-r from-green-200 via-green-400 to-purple-700"></div>
            </div>
            ...
            <div className="relative overflow-hidden bg-white shadow-xl rounded-xl">
                <div className="px-4 py-6 sm:px-8">
                    ...
                    <div className="flex items-center">
                        ...
                        <h3 className="text-xl font-bold text-lightGreen-300 font-pj">Sign in. &nbsp;  </h3> <h4 className="text-lg text-gray-900 font-pj"> Recieve your magic link by email. </h4>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="mt-2.5">
                                    <input type="email" name="email" id="email" placeholder="Email address" className="block w-full px-4 py-4 text-gray-900 placeholder-gray-600 bg-white border border-gray-400 rounded-xl focus:border-gray-900 focus:ring-gray-900 caret-gray-900" />
                                </div>
                            </div>
{/* 
                            <div>
