...
export default function HomePage() {
  ...
  return (
    <>
      <NextSeo
        title="Find a Frontend Engineer Job"
        description="Join an eCommerce brand hiring Frontend Engineer"
        openGraph={{
          url: 'https://ecomportal.co',
          title: "Find a Frontend Engineer Job",
          description: "Join an eCommerce brand hiring Frontend Engineers",
          images: [
              {
    ...
    <div>
        ...
        <a href="#" class="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
            <span class="text-xs bg-lightGreen-300 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span class="text-sm font-medium">2 Frontend Engineer jobs have been uploaded this week</span> 
            <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
        </a>
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Frontend Engineer  Jobs</h1>
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Browse our curated list of eCommerce brands hiring <span className="font-bold text-white italic">Frontend Engineers</span></p>
        </div>
        </div>
        <div className="flex  bg-gray-900 flex-row justify-between items-start px-7 xl:px-10 2xl:px-32 gap-6 mb-5">
          <InstantSearch searchClient={searchClient} indexName="ecomjobs_index">
            <Configure hitsPerPage={10} filters={`job_position:"Frontend Developer" OR job_position:"Front-end Engineer" OR job_position:"Front-end Developer" OR job_position:"Front End Developer" OR job_position:"Frontend Software Engineer II"`}/>
