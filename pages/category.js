...
function index() {
    return (
        ...
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Handpicked eCommerce categories that will help you find a job you’ll love. </p>
        </div>
        <div class="gap-16 items-center lg:-mt-20 py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div class="-mr-4 grid grid-cols-5 gap-4 mt-8">
