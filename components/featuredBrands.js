...
return (
    ...
    <div class="pb-8 px-4  mx-auto max-w-screen-xl text-center lg:py-4 lg:px-12">
        {/* <a class="hidden lg:inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm  bg-bnr rounded-full text-white  " role="alert">
            <span class="text-xs bg-[#fff366] rounded-full text-black px-4 py-1.5 mr-3">New</span> <span class="text-sm font-Studio6">74 new jobs have been uploaded this week</span> 
            <svg class="ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
        </a> */}
        <h1 class="mb-10 text-4xl lg:text-6xl lg:-mx-0 -mx-4 font-Studio6 tracking-tight leading-none ">Jobs and talent in the  <br></br>DTC community 🚀🛍💰</h1>
            ...
            sm:text-sm focus:ring-gray-900 focus:border-gray-900"
              ...
              <div class="relative group">
                ...
                <button
                  ...
                  class="inline-flex relative items-center justify-center w-full sm:w-auto px-8 py-3 sm:text-sm text-base sm:py-3.5 font-bold text-black transition-all duration-200 bg-[#fff366] border border-transparent rounded-lg  hover:bg-[#e0db79] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600"
                >
                  Subscribe
                </button>
...
// //             </dh-component>
// //         </div>
// // //     <section class="content-wrapper hidden md:block"  id="featuredStartups">
// // <div class="content">
// // <h3 class="uppercase font-medium text-sm tracking-wide text-gray-600">Featured Startups</h3>
// // <div class="promotedCompanies mt-2 grid grid-cols-4 gap-3 mb-16"><a class="rounded p-4 bg-gray-50 hover:bg-gray-100 relative transition duration-300 hover:scale-[102%] active:scale-[98%] flex flex-col gap-2" href="/@coinbase"><div class="flex gap-2 items-center">
...
// // 232 open positions
// // </div>
// // </a><a class="rounded p-4 bg-gray-50 hover:bg-gray-100 relative transition duration-300 hover:scale-[102%] active:scale-[98%] flex flex-col gap-2" href="/@airbnb"><div class="flex gap-2 items-center">
...
// // 98 open positions
// // </div>
// // </a><a class="rounded p-4 bg-gray-50 hover:bg-gray-100 relative transition duration-300 hover:scale-[102%] active:scale-[98%] flex flex-col gap-2" href="/@spotify"><div class="flex gap-2 items-center">
// // <img class="aspect-square object-fit h-6 w-6 rounded shrink-0" src="/logos/1438"/>
// // <h4 class="font-bold">Spotify</h4>
// // </div>
// // <div class="leading-snug">Join the band</div>
// // <div class="text-sm text-gray-600 mt-auto pt-2 font-medium">
// // 36 open positions
// // </div>
// // </a></div>
