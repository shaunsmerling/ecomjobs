  ...
  return (
    <>
      <div className="">
        ...
        <h1 class="mb-4 text-3xl lg:-mx-0 -mx-4 font-extrabold tracking-tight leading-none text-black">New Job Alerts</h1>
        <p class="mb-8 text-md font-normal text-black lg:text-md sm:px-16 xl:px-48 ">Subscribe to our email list to get new jobs sent <span className="italic font-bold">directly to your inbox </span></p>
        <form
              action="#"
