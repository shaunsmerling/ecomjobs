...
<a target="_blank" class="border border-black whitespace-nowrap  transform transition duration-300 hover:-translate-y-1 hover:shadow-lg inline-flex items-center  justify-center pl-3 pr-3 py-1  rounded-full shadow-sm text-base font-Studio6 text-white  bg-insightblue " href="https://www.theinsightai.com/subscribe">
The Insight
</a>
