...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/employers/posts">
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/employers/companyprofile">
<div class="ml-2 flex text-base font-medium text-gray-900">
  <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/contactus">
<div class="ml-2 flex text-base font-medium text-gray-900">
  <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/bulkdiscounts">
<div class="ml-2 flex text-base font-medium text-gray-900">
  <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/api/auth/signout">
<div class="ml-2 flex text-base font-medium text-gray-900">
  <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/companylist">
<div class="ml-2 flex text-base font-medium text-gray-900">
<div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/blog">
<div class="ml-2 flex text-base font-medium text-gray-900">
  <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
...
<a class="-m-3 p-3 flex items-center rounded-lg hover:bg-gray-50" href="/api/auth/signin">
<div class="ml-2 flex text-base font-medium text-gray-900">
  <div className="flex-shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-[#17614A]  text-white mr-2" >
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
  <path fill-rule="evenodd" d="M18.685 19.097A9.723 9.723 0 0021.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 6.615 2.25 12a9.723 9.723 0 003.065 7.097A9.716 9.716 0 0012 21.75a9.716 9.716 0 006.685-2.653zm-12.54-1.285A7.486 7.486 0 0112 15a7.486 7.486 0 015.855 2.812A8.224 8.224 0 0112 20.25a8.224 8.224 0 01-5.855-2.438zM15.75 9a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" clip-rule="evenodd" />
...
<div className=" border-t-2 mb-10 mx-auto">
<a href="/postajob" title=""
              className="inline-flex items-center justify-center px-20 mt-6 py-2.5 text-base font-medium  transition-all duration-200 border border-gray-900 rounded-full bg-[#17614A] text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring-900"
              role="button">
             Post A Job 
